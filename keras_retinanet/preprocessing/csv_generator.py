...
def _read_annotations(csv_reader, classes):
    ...
    for line, row in enumerate(csv_reader):
        ...
        try:
            img_file, x1, y1, x2, y2, a, class_name = row[:7]
        except ValueError:
        ...
        a = _parse(a, float, 'line {}: malformed a: {{}}'.format(line))
        ...
        result[img_file].append({'x1': x1, 'x2': x2, 'y1': y1, 'y2': y2, 'a': a, 'class': class_name})
    return result
